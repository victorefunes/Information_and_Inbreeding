...
data_1 <- left_join(data_1, cdn[, c("reg_id", "inbreeding")], by = "reg_id")
inb_alt <- read_csv("../data/inb_alt_1.csv")
data_1 <- left_join(data_1, inb_alt, by = "reg_id")
